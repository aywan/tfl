 ...
 */
final class Version20190615061351 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tf_game (id UUID NOT NULL, create_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, update_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, delete_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, score_a INT NOT NULL, score_b INT NOT NULL, state VARCHAR(32) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN tf_game.id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE tf_competition ADD CONSTRAINT FK_1C0C183A12469DE2 FOREIGN KEY (category_id) REFERENCES tf_category (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tf_competition DROP CONSTRAINT FK_1C0C183A12469DE2');
        ...
        $this->addSql('DROP TABLE tf_game');
