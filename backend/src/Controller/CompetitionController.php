...
{
    /**
     * @Route("/index", name="competition_index", methods={"GET"})
     */
    ...
    {
        $competitionData = new CompetitionRequest();
        $form = $this->createForm(CompetitionType::class, $competitionData);
        $form->handleRequest($request);

        if ($form->isSubmitted() && $form->isValid()) {
            $competition = new Competition();

            $competitionData->fill($competition);
